...
var _12=_11.children("div.combobox-book-hover");
if(!_12.length){
_12=_11.children("div.combobox-book-selected");
}
_12.removeClass("combobox-book-hover");
var _13="div.combobox-book:visible:not(.combobox-book-disabled):first";
var _14="div.combobox-book:visible:not(.combobox-book-disabled):last";
if(!_12.length){
...
if(_12.length){
_12.addClass("combobox-book-hover");
...
_25.find("div.combobox-book-selected").removeClass("combobox-book-selected");
var vv=[],ss=[];
for(var i=0;i<_22.length;i++){
var v=_22[i];
var s=v;
_24.finder.getEl(_21,v).addClass("combobox-book-selected");
...
dd.push("<div id=\""+(_2a.bookIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
...
_38.find("div.combobox-book-selected,div.combobox-book-hover").removeClass("combobox-book-selected combobox-book-hover");
_38.find("div.combobox-book,div.combobox-group").hide();
var _39=_36.data;
var vv=[];
...
vv.push(v);
_3b.addClass("combobox-book-selected");
}
...
var _40=_3f.children("div.combobox-book-hover");
if(_40.length){
var row=_3e.finder.getRow(_3d,_40);
var _41=row[_3e.valueField];
if(_3e.multiple){
if(_40.hasClass("combobox-book-selected")){
...
var _46=$(e.target).closest("div.combobox-book");
if(!_46.hasClass("combobox-book-disabled")){
_46.addClass("combobox-book-hover");
}
e.stopPropagation();
...
var _47=$(e.target).closest("div.combobox-book");
if(!_47.length||_47.hasClass("combobox-book-disabled")){
return;
}
...
if(_45.multiple){
if(_47.hasClass("combobox-book-selected")){
_1b(_43,_48);
}else{
_15(_43,_48);
}
...
_51.find("div.combobox-book-selected").removeClass("combobox-book-selected");
});
},reset:function(jq){
return jq.each(function(){
...
var _68=_2(_66,_67);
var id=$.data(_66,"combobox").bookIdPrefix+"_"+_68;
return $("#"+id);
},getRow:function(_69,p){
var _6a=$.data(_69,"combobox");
var _6b=(p instanceof jQuery)?p.attr("id").substr(_6a.bookIdPrefix.length+1):_2(_69,p);
