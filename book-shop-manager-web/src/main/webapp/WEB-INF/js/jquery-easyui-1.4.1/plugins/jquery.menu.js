...
_a[0].bookName=_b.name||"";
_a[0].bookHref=_b.href||"";
var _c=_a.addClass("menu-book").html();
...
if(!this.submenu){
_1b(_1c);
var _1e=this.bookHref;
if(_1e){
location.href=_1e;
}
}
var _1f=$(_1c).menu("getBook",this);
...
_2f(_2e);
_2e.find("div.menu-book").each(function(){
if(this.submenu){
_22(this.submenu);
}
$(this).removeClass("menu-active");
...
var tmp=$("<div></div>");
function _34(_35){
_35.children("div.menu-book").each(function(){
var _36=$(_31).menu("getBook",this);
...
var _3f=$("<div class=\"menu-book\"></div>").appendTo(_3d);
...
if(_3c.name){
_3f[0].bookName=_3c.name;
}
if(_3c.href){
_3f[0].bookHref=_3c.href;
}
if(_3c.onclick){
...
function _4b(_4c){
$(_4c).children("div.menu-book").each(function(){
_40(_4c,this);
});
if(_4c.shadow){
_4c.shadow.remove();
...
},getBook:function(jq,_52){
var t=$(_52);
var _53={target:_52,id:t.attr("id"),text:$.trim(t.children("div.menu-text").html()),disabled:t.hasClass("menu-book-disabled"),name:_52.bookName,href:_52.bookHref,onclick:_52.onclick};
...
return _53;
},findBook:function(jq,_55){
return _30(jq[0],_55);
},appendBook:function(jq,_56){
return jq.each(function(){
_3a(this,_56);
});
},removeBook:function(jq,_57){
return jq.each(function(){
_40(this,_57);
});
},enableBook:function(jq,_58){
return jq.each(function(){
_d(this,_58,false);
});
},disableBook:function(jq,_59){
return jq.each(function(){
_d(this,_59,true);
});
},showBook:function(jq,_5a){
return jq.each(function(){
_46(this,_5a,true);
});
},hideBook:function(jq,_5b){
return jq.each(function(){
_46(this,_5b,false);
});
