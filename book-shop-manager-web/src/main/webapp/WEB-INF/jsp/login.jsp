		...
		<div id="loginbox">
			<form id="formlogin" method="post" onsubmit="return false;">
				<div class="control-group normal_text">
					<h3>
						<span class="add-on" style="color: red;font-size: 7ex;">管</span>
						<span class="add-on" style="color: yellow;font-size: 7ex;">理</span>
						<span class="add-on" style="color: blue;font-size: 7ex;">员</span>
						<span class="add-on" style="color: green;font-size: 7ex;">登</span>
						<span class="add-on" style="color: #7CD3D3;font-size: 7ex;">录</span><!-- 
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
							<input type="button"  style="background-color: blue; padding-right:3%; width: 180px; height: 40px;" class="pull-right" id="loginsubmit" value="登录"/>
