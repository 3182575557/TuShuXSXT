...
<div id="bookAddForms" style="padding:10px 10px 10px 10px">
...
<script type="text/javascript">
	...
	$(function(){
		//创建富文本编辑器
		bookAddEditor = TAOTAO.createEditor("#bookAddForm [name=desc]");
		//初始化类目选择和图片上传器
		TAOTAO.init({fun:function(node){
			//根据图书的分类id取图书 的规格模板，生成规格信息。第四天内容。
			//TAOTAO.changeBookParam(node, "bookAddForm");
		}});
	});
	//提交表单
	function submitForm(){
