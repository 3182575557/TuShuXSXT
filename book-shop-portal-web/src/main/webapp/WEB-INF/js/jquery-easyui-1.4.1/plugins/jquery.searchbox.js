...
function _9(){
if(_3.menu){
var _e=_3.menu.children("div.menu-book:first");
_3.menu.children("div.menu-book").each(function(){
...
return _3.menu.menu("getBook",_e[0]);
}else{
return null;
}
};
...
if(_17){
_17.children("div.menu-book").each(function(){
var _18=_17.menu("getBook",this);
if(_18.name==_16){
