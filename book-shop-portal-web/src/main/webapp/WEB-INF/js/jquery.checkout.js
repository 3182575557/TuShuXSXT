...
var consigneeListOver = (function(){
    ...
    var init = function(){
        ...
        dom.find(".book").each(function(){
            ...
            if( !!$this.data("lock") ){
                $this.find(".book-action").show().removeClass("hide");
            }
            ...
            $this.bind("mouseenter", function(){
                if(!$this.data("lock")){
                    ...
                    if(!$this.data("lock")){
                        ...
                        $this.removeClass("book-selected");
                        $this.find(".book-action").hide().addClass("hide");
                    }
                });
        });
    };
...
var expandingMore = (function(){
    var expandHolder = $("#consignee-list"),
        ...
        book = expandHolder.find(".book-fore");
    expand = false;
    ...
    var init = function(){
        ...
        expandHandle.click(function(){
            ...
            book[expand ? "removeClass" : "addClass"]("hide").css("display", expand ? "block" : "none");
...
var bookListOver = {
    ...
    bindEvents: function(){
        ...
        if( !this.dom.find(".book").length ){
            return;
        }

        this.dom.find(".book").each(function(){
            var $this = $(this);
            ...
            $this.find(".hookbox").each(function(){
                $(this).bind("click", function(){
                    ...
                    self.dom.find(".book").removeClass("book-selected");
                    self.dom.find(".book .book-action").addClass("hide").hide();

                    $(this).attr("checked", "checked");

                    $this.addClass("book-selected");
                    $this.find(".book-action").removeClass("hide").show();
                });
            });
