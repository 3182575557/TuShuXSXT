 ...
 */
function login() {
    return location.href = "http://localhost:8082/page/login";
}
function regist() {
    return location.href = "http://localhost:8082/page/register";
}
...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function() {
    ...
    f.push('<div class="slide-bookswrap"><ul class="slide-books"><li class="'), f.push(g), f.push('" data-tag="'), f.push(b[0].aid), f.push('">');
