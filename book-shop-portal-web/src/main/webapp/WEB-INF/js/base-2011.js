...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function() {
    ...
    i.push('<div class="slide-bookswrap"><ul class="slide-books"><li class="'), i.push(j), i.push('" data-tag="'), i.push(b[0].aid), i.push('">');
...
if (function(a) {
    ...
    a.fn.jdTab = function(b, c) {
        ...
        var d = a.extend({type: "static",auto: !1,source: "data",event: "mouseover",currClass: "curr",tab: ".tab",content: ".tabcon",bookTag: "li",stay: 5e3,delay: 100,mainTimer: null,subTimer: null,index: 0}, b || {}), e = a(this).find(d.tab).eq(0).find(d.bookTag), f = a(this).find(d.content);
