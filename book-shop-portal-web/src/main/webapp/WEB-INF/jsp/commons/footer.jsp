	...
	<div id="service-2013">
		...
		<dl class="fore5">
			...
			<dd>		
				...
				<div><a href="#" target="_blank" rel="nofollow">书城E卡</a></div>
				<div><a href="#" target="_blank" rel="nofollow">书城优惠</a></div>
				<div><a href="#" target="_blank" rel="nofollow">书城通信</a></div>
			</dd>
		</dl>
		<div class="fr">
			<div class="sm" id="branch-office">
				...
				<div class="smc">
					<p>书店已向全国1859个区县提供自营配送服务，支持货到付款、POS机刷卡和售后上门服务。</p>
