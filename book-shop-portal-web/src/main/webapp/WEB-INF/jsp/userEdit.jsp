...
<div class="w" id="logo">
    <div>
    	<a href="http://localhost:8082">
    		<img src="/images/bookshop.gif" alt="育人书店" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
    ...
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
            <div class="form" onselectstart="return false;">
             ...
             <div class="book" id="select-regID">
                    <span class="label"><b class="ftx04">*</b>用户ID：</span>

                    <div class="fl book-ifo">
                        <div class="o-intelligent-regID">
                            <input type="text" id="regID" name="userID" class="text" tabindex="1" autoComplete="off"
                                   onpaste="return false;"
                                   value=""
                                   onfocus="if(this.value=='') this.value='';this.style.color='#333'"
                                   onblur="if(this.value=='') {this.value='';this.style.color='#999999'}"/>
                            <i class="i-ID"></i>
                            <ul id="intelligent-regID" class="hide"></ul>
                            <label id="regIDe_succeed" class="blank"></label>
                            <label id="regID_error" class="hide"></label>
                        </div>
                    </div>
                </div>
            
                <div class="book" id="select-regName">
                ...
                <div id="o-password">
                    ...
                    <div class="book" id="select-regEmail">
                    <span class="label"><b class="ftx04">*</b>邮箱：</span>

                    <div class="fl book-ifo">
                        <div class="o-intelligent-regEmail">
                ...
                <div class="book book-new">
                    <span class="label">&nbsp;</span>

                    <div class="fl book-ifo">
                        <input type="checkbox" class="checkbox" checked="checked" id="readme"
                               onclick="agreeonProtocol();">
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《用户修改协议》</a></label>
                        <span class="clr"></span>
