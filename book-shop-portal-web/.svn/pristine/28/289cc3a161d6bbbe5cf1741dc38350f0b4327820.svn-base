...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/bookshop.gif" title="返回书店首页" alt="返回书店首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-goods">图书</div>
        <div class="column t-price">图书价</div>
    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="book book_selected ">
		        <div class="book_form clearfix">
		            <div class="cell p-checkbox"><input data-bind="cbid:1" class="checkbox" type="checkbox" name="checkBook" checked="" value="11345721-1"></div>
		            <div class="cell p-goods">
		                ...
		                <div class="p-name">
		                	<a href="/book/${cart.id }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.title}</a>
		            ...
		            <div class="cell p-quantity" for-stock="for-stock-11345721">
		                <div class="quantity-form" data-bind="">
		                    ...
		                    <input type="text" class="quantity-text" bookPrice="${cart.price}" bookId="${cart.id}" value="${cart.num }" id="changeQuantity-11345721-1-1-0">
          ...
          <div class="cart-toolbar clearfix">
            ...
            <div class="amout fr"><span id="selectedCount">1</span> 件图书</div>
        </div>
          ...
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://localhost:8082/order/order-cart.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
