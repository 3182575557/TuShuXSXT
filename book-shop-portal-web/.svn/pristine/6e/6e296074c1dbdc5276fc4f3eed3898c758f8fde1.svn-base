 /*
 book.jd.com Compressed by uglify 
 Author:keelii 
...
function setSearch(t, e) {
    ...
    $.ajax({url: "http://api.search.jd.com/?key=" + s + "&pagesize=" + i + "&filt_type=wyn,L1M1;wstate,L1M1" + e,dataType: "jsonp",success: function(t) {
            var e = t.Summary.key;
            pageConfig.product.searchList = [], null !== t.Product && t.Product.length > 0 && (1 > $("#search-result").length && $("#product-intro").parent().before('<div class="w"><div id="search-result" class="m m2" clstag="shangpin|keycount|product|exrs"><div class="mt"></div><div class="mc search-book"></div></div></div>'), $("#search-result").show(), $("#search-result .search-book").html(search_TPL.process(t)), $("#search-result .mt").html('<h2>\u5728\u4eac\u4e1c\u5546\u57ce\u4e2d\u67e5\u770b\u5176\u5b83\u201c<a target="_blank" href="http://search.jd.com/Search?keyword=' + e + '">' + e + '</a>\u201d\u7684\u641c\u7d22\u7ed3\u679c\uff1a</h2><div class="extra"><a target="_blank" href="http://search.jd.com/Search?keyword=' + e + '">\u67e5\u770b\u66f4\u591a\u641c\u7d22\u7ed3\u679c</a></div>'), G.getPriceNum(pageConfig.product.searchList, null, $("#search-result")), $(".search-book dl .p-img a").click(function() {
            ...
            }), $(".search-book dl .p-name a").click(function() {
                var t = $(this).parents("dl").attr("skuid");
                $.getScript("http://sstat.jd.com/scslog?args=1^" + encodeURIComponent(e) + "^^1^^" + encodeURIComponent(document.referrer) + "^" + t + "^0^101^^0^0")
            }))
        }})
...
//        , $.ajax({url: "http://club.jd.com/ProductPageService.aspx?method=GetCommentSummaryBySkuId&referenceId=" + t + "&callback=getCommentCount",dataType: "script",cache: !0})
        ...
        var t = t || $(".suits");
        t.find("li").removeClass("last-book"), t.find("li:visible:last").addClass("last-book")
...
//            }})
        ...
        if (pageConfig.product.GrecommendSkus = [], t.success && t.data && t.data.length > 0) {
            if (105e3 === this.rid && this.el.html(listBrosweBrosweNew_TPL.process(t)).parent().show(), 102004 === this.rid && this.el.html(listBrosweBrosweNew_TPL.process(t)).parent().show(), 103001 === this.rid && this.el.html(listBrosweBuyNew_TPL.process(t)).parent().show(), 102003 === this.rid && this.el.html(listBrosweBuyNew_TPL.process(t)).parent().show(), 103002 === this.rid && (this.el.html(listBuyBuyNew_TPL.process(t)).parent().show(), log(G.mdPerfix + "2", "Show")), 102002 === this.rid && this.el.html(listBuyBuyNew_TPL.process(t)).parent().show(), 102001 === this.rid && (1315 == G.cat[0] || 11729 == G.cat[0] ? (pageConfig.product.cbCombineBuying = [pageConfig.product.skuid], s.set1315(t)) : i()), 103003 === this.rid && i(), 902029 === this.rid && this.el.html(listBrosweBuyPOP_TPL.process(t)).parent().show(), (102001 === this.rid || 103003 === this.rid) && G.getPriceNum(pageConfig.product.GrecommendSkus, null, this.el), 303001 === this.rid && this.el.html(addToCart_TPL.process(t)).parent().show(), 103e3 === this.rid || 102e3 === this.rid) {
                ...
                $("#nobook-list").imgScroll({visible: n,showControl: !0,step: n,loop: !1,prev: "#nobook-forward",next: "#nobook-backward",disableClass: "disabled"})
            }
            if (902011 === this.rid) {
                var o = pageConfig.wideVersion && pageConfig.compatible ? 4 : 3;
                t.json = e(t.data, o), this.el.html(bookDisabled.process(t)), this.el.parents(".clearfix").eq(0).attr("data-widget", "tabs").Jtab({compatible: !0,auto: !0})
            }
            if (902018 === this.rid) {
                var a = $("#nobook-list");
                this.el.html(bookDisabledReco.process(t)), $("#out-of-stock").show();
                var n = pageConfig.wideVersion && pageConfig.compatible ? 5 : 4;
                a.imgScroll({visible: n,showControl: !0,step: n,loop: !1,prev: "#nobook-forward",next: "#nobook-backward",disableClass: "disabled"}), G.getCommentData(pageConfig.product.GrecommendSkus, a, null)
            }
        ...
        if (t.success) {
            var p = '<div id="stabcon_pop" class="stabcon stabcon_big"><div class="master">    <s></s>    <div class="p-img">        <a href="http://book.jd.com/${G.sku}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(G.sku)}n2/${G.src}" height="160" width="160"></a>    </div>    <div class="p-name">        <a href="http://book.jd.com/${G.sku}.html" target="_blank">${G.name}</a>    </div>    <div class="p-price none"><input type="checkbox" id="inp_${G.sku}_hot" onclick="return false;" onchange="return false" wmaprice="${pageConfig.product.mp}" wmeprice="${pageConfig.product.jp}" skuid="${G.sku}" checked/> ${pageConfig.product.jp}</div></div><div class="pop-wrap"><div id="pop-box" class="">    <div id="p-scroll"></div>    <div id="p-size"></div>    <div id="p-tips"></div>    <div id="p-size-btn">        <a href="#none" id="p-selected-ok">\u786e\u5b9a</a><a id="p-selected-cancel" href="#none">\u53d6\u6d88</a>    </div></div><div class="suits" style="overflow-x:{if parseInt(data.length)>(pageConfig.wideVersion&&pageConfig.compatible ? 3:2)}scroll;{else}hidden;{/if}">    <ul class="lh" style="width:${parseInt(data.length)*200+20}px">        {for book in data}        <li data-push="${pageConfig.product.cbCombineBuyingPop.push(book.sku)}" class="pop-list {if parseInt(book_index)+1==parseInt(data.length)} last-book{/if}" id="pop-list-${book_index}" data-sku="${book.sku}" data-ind="${book_index}" onclick="reClick(\'${G.mdPerfix}3\', \'${G.sku}\', \'${book.sku}#${book.jp}\', \'${book_index}\');" data-clk="${book.clk}">            <s></s>            <div class="p-img">                <a href="http://book.jd.com/${book.sku}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(book.sku)}n2/${book.img}" alt="" height="160" width="160"></a>            </div>            <div class="p-scroll">                <a href="javascript:;" class="p-scroll-btn p-scroll-prev">&lt;</a>                <div class="p-scroll-wrap">                    <ul>                    {for color in book.subsku}                        {if parseInt(color_index)==0}<li><a href="javascript:;" class="no-scroll curr" title="${book.popco}"><img data-img="1" width="25" height="25" alt="" src="${pageConfig.FN_GetImageDomain(book.sku)}n5/${book.img}"></a></li>{/if}                        <li><a href="javascript:;" class="{if parseInt(color_index)==0}curr{/if}" data-sku="${book.sku}" title="${color.hit}"><img data-img="1" width="25" height="25" alt="" src="${pageConfig.FN_GetImageDomain(book.sku)}n5/${color.img}" data-img="1"></a></li>                    {forelse}                        <li><a href="javascript:;" class="no-scroll curr" title="\u65e0"><img data-img="1" width="25" height="25" alt="" src="${pageConfig.FN_GetImageDomain(book.sku)}n5/${book.img}"></a></li>                    {/for}                    </ul>                </div>                <a href="javascript:;" class="p-scroll-btn p-scroll-next">&gt;</a>            </div>            <div class="p-name">                <a href="http://book.jd.com/${book.sku}.html" target="_blank">${book.t}</a>            </div>            <div class="choose">                <input type="checkbox" data-nocolor="${book.subsku.length<1}" id="inp_${book.sku}" class="{if parseInt(book.subsku.length)==0}no-pop-win{/if}" wmaprice="${book.wmaprice}" wmeprice="${book.jp}" skuid="${book.sku}" />                <label for="inp_${book.sku}" class="p-price">                    <strong class="J-p-${book.sku}"></strong>                </label>            </div>        </li>        {/for}    </ul></div></div><div class="infos" onclick="{for book in data}reClick(\'${G.mdPerfix}3\', \'${G.sku}\', \'${book.sku}#${book.jp}\', \'${book_index}\');{/for}">    <s></s>    <div class="p-name">        <a onclick="log(\'${G.mbPerfix}PopularBuy\',\'click\')" href="http://jd2008.jd.com/purchase/OrderFlowService.aspx?action=AddSkus&wids=${G.sku}">\u8d2d\u4e70\u4eba\u6c14\u7ec4\u5408</a>    </div>    <div class="p-price">\u603b\u4eac\u4e1c\u4ef7\uff1a        <strong class="res-jdprice">\uffe5 ${pageConfig.product.jp}</strong>    </div>    <div class="p-saving">\u603b\u53c2\u8003\u4ef7\uff1a        <del class="res-totalprice">\uffe5 ${pageConfig.product.mp}</del>    </div>    <div class="btns">        <a onclick="log(\'${G.mbPerfix}PopularBuy\',\'click\')" class="btn-buy" href="http://jd2008.jd.com/purchase/OrderFlowService.aspx?action=AddSkus&wids=${G.sku}">\u8d2d\u4e70\u7ec4\u5408</a>    </div></div><div class="clb"></div></div>';
...
//            }}) : 6728 == G.cat[0] && G.isJd ? $.ajax({url: "http://misc.360buyimg.com/product/js/2012/fittingsAuto.js?ver=20140424",dataType: "script",cache: !0}) : $.getJSONP("http://d.360buy.com/fittingInfo/get?skuId=" + t + "&callback=Recommend.cbRecoFittings"), void 0)
        ...
        var e = $("#tab-reco"), i = {accessoryList: []}, s = {tabs: '<div class="tab-cat stab">    <ul>        {if pageConfig.product.cat[1]!=830}            <li id="tab-cat-0" class="fl scurr" data-widget="tab-book" data-cat="\u914d\u4ef6\u9009\u8d2d\u4e2d\u5fc3|3">\u7cbe\u9009\u914d\u4ef6</li>            {for tab in accessoryList}            <li id="tab-cat-${parseInt(tab_index)+1}" class="fl" data-widget="tab-book" data-cat="${tab.thirdName}|${tab.thirdTypeId}">${tab.thirdName}</li>            {/for}        {else}            {for tab in accessoryList}            <li id="tab-cat-${parseInt(tab_index)+1}" class="{if Number(tab_index)==0}scurr{/if} fl" data-widget="tab-book" data-cat="${tab.thirdName}|${tab.thirdTypeId}">${tab.thirdName}</li>            {/for}        {/if}    </ul></div>',cons: '<div id="newFittign-tab"  data-widget="tabs"><div class="master">    <s></s>    <div class="p-img">        <a href="http://book.jd.com/${mainproduct.sku}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(mainproduct.sku)}n4/${mainproduct.imageUrl}" height="100" width="100"></a>    </div>    <div class="p-name">        <a href="http://book.jd.com/${mainproduct.sku}.html" target="_blank">${mainproduct.name}</a>    </div>    <div class="p-price"><input id="inp_${mainproduct.sku}_reco" type="checkbox" onclick="return false;" onchange="return false" wmeprice="{if mainproduct.price==""}0.00{else}${mainproduct.price}{/if}" wmaprice="${mainproduct.maPrice}" skuid="${mainproduct.sku}" checked/> ${mainproduct.price}</div></div><div class="suits" style="width:${pageConfig.wideVersion&&pageConfig.compatible?(4*165-40):(3*128)}px;overflow-x:{if G.cat[1]!=830}auto{else}hidden{/if};overflow-y:hidden;">    {for tab in accessoryList}    <ul id="newFitting-${parseInt(tab_index)+1}" data-cat="${tab.thirdName}" style="width:${G.cat[1]==830?165*tab.accessoryList.length:660}px;" class="{if G.cat[1]==830}{if Number(tab_index)!=0}hide{/if}{else}hide{/if} lh" data-widget="tab-content">        {if G.cat[1]==830}            {for list in tab.accessoryList}            <li data-push="${pageConfig.product.cbNewFittings.push(list.sku)}" {if (parseInt(list_index)+1)==tab.accessoryList.length} class="last_book"{/if} onclick=\'${pageConfig.setFittingsClk(G.cat[2], G.sku, list.sku, 50, list_index, "rodGlobalTrack")}\'>                <s></s>                <div class="p-img">                    <a href="http://book.jd.com/${list.sku}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(list.sku)}n4/${list.imageUrl}" alt="" height="100" width="100"></a>                </div>                <div class="p-name">                    <a href="http://book.jd.com/${list.sku}.html" target="_blank">${list.name}</a>                </div>                <div class="choose">                    <input type="checkbox" id="inp_${list.sku}" onclick="G.calculatePrice(this, \'#tab-reco\')" wmaprice="${list.maPrice}" wmeprice="${list.price}" skuid="${list.sku}" />                    <label for="inp_${list.sku}" class="p-price">                        <strong class="J-p-${list.sku}"></strong>                    </label>                </div>            </li>            {/for}        {else}            <div class="iloading">\u52a0\u8f7d\u4e2d...</div>        {/if}    </ul>    {/for}</div><div class="infos">    {if pageConfig.product.cat[1]!=830}<div id="more-fitting-link"><a class="hl_link" href="http://rs.jd.com/accessorie/center.html?sku=${G.sku}&thirdTypeId=3" target="_blank">\u8fdb\u5165\u914d\u4ef6\u9009\u8d2d\u4e2d\u5fc3</a><span>&gt;<b></b></span></div>{/if}    <s></s>    <div class="p-name">        <em>\u5df2\u9009\u62e9<span>0</span>\u4e2a\u914d\u4ef6</em>    </div>    <div class="p-price">\u642d&nbsp;&nbsp;\u914d&nbsp;&nbsp;\u4ef7\uff1a        <strong class="res-jdprice">{if mainproduct.price==""}\u6682\u65e0\u62a5\u4ef7{else}\uffe5 ${parseFloat(mainproduct.price).toFixed(2)}{/if}</strong>    </div>    <div class="p-saving">\u53c2&nbsp;&nbsp;\u8003&nbsp;&nbsp;\u4ef7\uff1a        <span class="res-totalprice">\uffe5 ${parseFloat(mainproduct.maPrice).toFixed(2)}</span>    </div>    <div class="btns">        <a class="btn-buy" href="http://jd2008.jd.com/purchase/OrderFlowService.aspx?action=AddSkus&wids=${G.sku}">\u7acb\u5373\u8d2d\u4e70</a>    </div></div></div>',book: '{for book in accessoryList}<li data-push="${pageConfig.product.cbNewFittings.push(book.sku)}" {if (parseInt(book_index)+1)==accessoryList.length} class="last_book"{/if}  onclick=\'${pageConfig.setFittingsClk(G.cat[2], G.sku, book.sku, 34, book_index)};\'>    <s></s>    <div class="p-img">        <a href="http://book.jd.com/${book.sku}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(book.sku)}n4/${book.imageUrl}" alt="" height="100" skuidth="100"></a>    </div>    <div class="p-name">        <a href="http://book.jd.com/${book.sku}.html" target="_blank">${book.name}</a>    </div>    <div class="choose">        <input type="checkbox" id="inp_m_${book.sku}" onclick="G.calculatePrice(this, \'#tab-reco\')" wmaprice="${book.maPrice}" wmeprice="${book.price}" skuid="${book.sku}" />        <label for="inp_m_${book.sku}" class="p-price">            <strong class="J-p-${book.sku}"></strong>        </label>    </div>    {if isExtra==true}    <div class="p-more{if (parseInt(book_index)+1)!==accessoryList.length} hide{/if}"><a class="hl_link" href="http://rs.jd.com/accessorie/center.html?sku=${G.sku}&thirdTypeId=${book.thirdType}" target="_blank"></a></div>    {else}    <div class="p-more"><a class="hl_link" href="http://rs.jd.com/accessorie/center.html?sku=${G.sku}&thirdTypeId=${book.thirdType}" target="_blank">\u66f4\u591a${book.thirdName}</a></div>    {/if}</li>{/for}'};
        if (pageConfig.product.cbNewFittings = [pageConfig.product.skuid], pageConfig.setFittingsClk = function(t, e, i, s, a) {
            var n = {cid: t,mainSku: e,bookSku: i,id: s,ind: a,str: "rodGlobalTrack"};
            return 830 === G.cat[1] && (n.cid = "", n.mainSku = ""), n.rid = 830 === G.cat[1] ? 402002 : 402001, 'clsClickLog("${cid}", "${mainSku}", "${bookSku}", ${id}, "${ind}", "${str}");G.clsLog(${rid}, "1", ${G.sku}, ${bookSku}, ${ind});'.process(n)
            ...
            if (e.attr("loaded", "true").html(s.cons.process(t)), 830 != pageConfig.product.cat[1]) {
                ...
                $("#newFittign-tab .suits").prepend('<ul id="newFitting-0" class="lh" data-widget="tab-content" style="width:' + 165 * i.accessoryList.length + 'px">' + s.book.process(i) + "</ul>")
            }
                ...
                if (830 != G.cat[1])
                    if (c.attr("href", "http://rs.jd.com/accessorie/center.html?sku=" + G.sku + "&thirdTypeId=" + o).html("\u8fdb\u5165" + r), n.scrollLeft(0), 0 !== a) {
                        ...
                        window.fetchJSON_fittingExtra = function(t) {
                            ...
                            t.isExtra = !0, t.accessoryList = t.accessoryList.slice(0, i), $("#newFitting-" + a).html(s.book.process(t)).attr("loaded", "1"), $("#newFitting-" + a).find(".hl_link").html("\u66f4\u591a" + $("#tab-cat-" + a).html());
                            try {
...
var Refresh = {init: function() {
        ...
        this.commList.find(".book-reply").hover(function() {
        ...
        this.commList.find(".btn-toggle").unbind("click").bind("click", function() {
            var e = $(this), i = e.parents(".i-book"), s = e.attr("data-id");
        ...
        return "" === t.content.replace(/\s+/, "") ? (alert("\u8bf7\u8f93\u5165\u56de\u590d\u5185\u5bb9"), !1) : 1 > s.length || s.length > 800 ? (alert("\u56de\u590d\u5185\u5bb9\u5e94\u57281~400\u4e2a\u5b57\u4ee5\u5185"), !1) : ($.ajax({url: "http://club.jd.com/index.php?",data: i,dataType: "jsonp",success: function(i) {
                1 === i.status ? (i.data.nickname = t.nickname, e.setReplyBook(i.data)) : i.info && alert(i.info)
            }}), void 0)
    },setReplyBook: function(t) {
        var e, i = this, s = i.currReply.parents(".i-book").eq(0), a = s.find(".reply-lz"), n = i.currReply.parents(".reply-list").eq(0), o = n.find(".parentReplyFrom"), r = this.currReply.parents(".book-reply").eq(0), c = a.next();
        ...
        $("#commentsPage" + t.score).pagination(t.productCommentSummary[i], {books_per_page: 10,num_display_entries: 5,current_page: e.page,num_edge_entries: 2,link_to: "#comments-list",prev_text: "\u4e0a\u4e00\u9875",next_text: "\u4e0b\u4e00\u9875",ellipse_text: "...",prev_show_always: !1,next_show_always: !1,callback: function(i) {
        ...
        var e = $("#discuss-comment"), i = '<tbody>    {for book in Comments}    <tr>        <td class="col1">            <div class="topic">                <b class="icon lun"></b>                <a href="http://club.jd.com/CommunityGroupDetail/${book.id}_1.html" target="_blank">${book.title}</a>            </div>        </td>        <td class="col2">${book.replyCount}/${book.viewCount}</td>        <td class="col3">            <div class="u-name">                <a target="_blank" title="${comment.uRemark}" href="http://me.jd.com/${book.uid}.html">{if book.uRemark}${book.uRemark}{else}${book.nickname}{/if}</a>            </div>        </td>        <td class="col4">${book.creationTime}</td>    </tr>    {/for}</tbody>';
        ...
        $.ajax({url: s,dataType: "jsonp",data: {wid: t,keyword: encodeURI(e),page: i,ps: 5},success: function(t) {
                ...
                if (t.length > 0) {
                    ...
                    if ($("#consult .tabcon:visible").html(n + "" + consult_search_TPL.process(t[0]) + e), 0 >= t[0].list.length || 0 >= t[0].total)
                        return !1;
                    $("#ReferPagenation").show().pagination(t[0].total, {books_per_page: 5,num_display_entries: 5,current_page: i - 1,num_edge_entries: 0,link_to: "#consult",prev_text: "\u4e0a\u4e00\u9875",next_text: "\u4e0b\u4e00\u9875",ellipse_text: "...",prev_show_always: !1,next_show_always: !1,callback: function(t) {
        ...
        }, this.url = "", this.typeMap = {t2: "ycbs",t3: "ycbs",t4: "ycbs",t6: "ywbh",t7: "ywbh",t9: "yhdx"}, this.bookTPL = '<div class="book">    {if arguments[2][0]&&arguments[2][1]==0}        <ins class="yb-book-more">\u66f4\u591a</ins>    {/if}    <b></b>    <a class="yb-link" href="http://fuwu.jd.com" target="_blank"><i class="yb-ico"></i></a>    <a href="#none" class="yb-book {if arguments[2][0]&&arguments[2][1]==0} yb-book-first{/if}" id="yb-pid-${platformPid}" data-type="${sortId}" data-sku="${platformPid}" title="${G.showServiceDesc(sortId)}">${sortName} \uffe5${price}</a></div>', this.TPL = '<div class="service-type-yb">    {if r1.length>0}        <div class="yb-book-cat yb-book-cat-r1">            ${JdService.bookTPL.process(r1[0], [r1.length>1, 0])}            <div class="yb-book-hide">                {for book in r1}                    {if book_index!=0}${JdService.bookTPL.process(book, [r1.length>1])}{/if}                {/for}            </div>        </div>    {/if}    {if r2.length>0}        <div class="yb-book-cat yb-book-cat-r2">            ${JdService.bookTPL.process(r2[0], [r2.length>1, 0])}            <div class="yb-book-hide">                {for book in r2}                    {if book_index!=0}${JdService.bookTPL.process(book, [r2.length>1])}{/if}                {/for}            </div>        </div>    {/if}    {if r3.length>0}        <div class="yb-book-cat yb-book-cat-r3">            ${JdService.bookTPL.process(r3[0], [r3.length>1, 0])}            <div class="yb-book-hide">                {for book in r3}                    {if book_index!=0}${JdService.bookTPL.process(book, [r3.length>1])}{/if}                {/for}            </div>        </div>    {/if}    {if r4.length>0}        <div class="yb-book-cat yb-book-cat-r4">            ${JdService.bookTPL.process(r4[0], [r4.length>1, 0])}            <div class="yb-book-hide">                {for book in r4}                    {if book_index!=0}${JdService.bookTPL.process(book, [r4.length>1])}{/if}                {/for}            </div>        </div>    {/if}    {if r5.length>0}        <div class="yb-book-cat yb-book-cat-r5">            ${JdService.bookTPL.process(r5[0], [r5.length>1, 0])}            <div class="yb-book-hide">                {for book in r5}                    {if book_index!=0}${JdService.bookTPL.process(book, [r5.length>1])}{/if}                {/for}            </div>        </div>    {/if}    <div class="yb-book-cat yb-book-detail"><a class="hl_blue" target="_blank" href="http://sale.jd.com/act/1pChm0RcanBPYXIS.html?erpad_source=erpad">\u8be6\u60c5</a></div></div>', this.yb_TPL = '        <div class="service-type-yb">            {for data in list}            <div class="yb-book-cat ${data.cName}">                <div class="book">                    {if data.books.length > 1}<ins class="yb-book-more">\u66f4\u591a</ins>{/if}                    <b></b>                    <a class="yb-link" href="http://fuwu.jd.com" target="_blank"><i class="yb-ico"></i></a>                    <a href="#none" class="yb-book {if data.books.length > 1} yb-book-first{/if}" id="yb-pid-${data.books[0].platformPid}" data-type="${data.books[0].sortId}" data-sku="${data.books[0].platformPid}" title="${G.showServiceDesc(data.books[0].sortId)}">${data.books[0].sortName} \uffe5${data.books[0].price}</a>                </div>                {if data.books.length > 1}                <div class="yb-book-hide">                    {for yb in data.books}                    {if Number(yb_index)>0}                    <div class="book">                        <b></b>                        <a class="yb-link" href="http://fuwu.jd.com" target="_blank"><i class="yb-ico"></i></a>                        <a href="#none" class="yb-book" id="yb-pid-${yb.platformPid}" data-type="${yb.sortId}" data-sku="${yb.platformPid}" title="${G.showServiceDesc(yb.sortId)}">${yb.sortName} \uffe5${yb.price}</a>                    </div>                    {/if}                    {/for}                </div>                {/if}            </div>            {/for}            <div class="yb-book-cat yb-book-detail">                <a class="hl_blue" target="_blank" href="http://sale.jd.com/act/1pChm0RcanBPYXIS.html?erpad_source=erpad">\u8be6\u60c5</a>            </div>        </div>', this.get()
    },bindEvent: function() {
        var t = this;
        this.obj.find(".service-type-yb .book a").bind("click", function() {
            var e = $(this), i = e.attr("data-sku"), s = (e.attr("data-type"), e.parent(".book")), a = e.parents(".yb-book-cat");
            s.hasClass("selected") ? s.removeClass("selected") : (a.find(".book").removeClass("selected"), s.addClass("selected")), t.currSku = i, t.currEl = e, t.calResult()
        })
    },addCurrStyle: function(t) {
        var e = t.parents(".service-type").eq(0), i = e.find(".book");
        i.removeClass("selected"), t.parent(".book").eq(0).addClass("selected")
    },removeCurrStyle: function(t) {
        t.parent(".book").eq(0).removeClass("selected")
    },get: function() {
//        var t = this;
...
//            }})
        ...
        for (e = 0; a > e; e++)
            i = RegExp("-" + t[e].sortId + "-"), i.test("-2-3-4-44-49-") ? (n.list[0] || (n.list[0] = {}, n.list[0].books = [], n.list[0].cName = "yb-book-cat-r0"), n.list[0].books.push(t[e])) : i.test("-6-7-41-47--") ? (n.list[1] || (n.list[1] = {}, n.list[1].books = [], n.list[1].cName = "yb-book-cat-r1"), n.list[1].books.push(t[e])) : i.test("-9-48-60-") ? (n.list[2] || (n.list[2] = {}, n.list[2].books = [], n.list[2].cName = "yb-book-cat-r2"), n.list[2].books.push(t[e])) : i.test("-11-50-") ? (n.list[3] || (n.list[3] = {}, n.list[3].books = [], n.list[3].cName = "yb-book-cat-r3"), n.list[3].books.push(t[e])) : i.test("-15-16-17-18-45-46-61-63-") ? (n.list[4] || (n.list[4] = {}, n.list[4].books = [], n.list[4].cName = "yb-book-cat-r4"), n.list[4].books.push(t[e])) : i.test("-20-21-22-76-77-85-86-87-") ? (n.list[5] || (n.list[5] = {}, n.list[5].books = [], n.list[5].cName = "yb-book-cat-r5"), n.list[5].books.push(t[e])) : i.test("-27-28-31-32-67-68-69-70-78-79-") ? (n.list[6] || (n.list[6] = {}, n.list[6].books = [], n.list[6].cName = "yb-book-cat-r6"), n.list[6].books.push(t[e])) : i.test("-42-64-65-66-71-72-73-74-80-81-") ? (n.list[7] || (n.list[7] = {}, n.list[7].books = [], n.list[7].cName = "yb-book-cat-r7"), n.list[7].books.push(t[e])) : i.test("-52-53-54-57-58-59-75-82-83-84-") ? (n.list[8] || (n.list[8] = {}, n.list[8].books = [], n.list[8].cName = "yb-book-cat-r8"), n.list[8].books.push(t[e])) : (n.list[9] || (n.list[9] = {}, n.list[9].books = [], n.list[9].cName = "yb-book-cat-r9"), n.list[9].books.push(t[e]));
        if (s.list.length > 0) {
            this.obj.html(this.yb_TPL.process(n)).parent().show(), pageConfig.product.hasYbInfo = !0;
            var o = this.obj.find(".yb-book-cat");
            o.hover(function() {
                $(this).addClass("yb-book-hover")
            }, function() {
                $(this).removeClass("yb-book-hover")
            }), o.each(function() {
                var t = $(this).width();
                $(this).find(".book").css("width", t)
            })
        } else
            this.obj.parent().hide();
        this.bindEvent(), this.bookCount = s.list.length
    },addBook: function(t) {
        this.resObj["p" + t] = t
    },removeBook: function(t) {
        this.resObj["p" + t] = null
    },calResult: function() {
        var t = this.obj.find(".selected"), e = [];
        return t.each(function() {
            var t = $(this).find(".yb-book"), i = t.attr("data-sku");
            i && e.push(i)
...
(function() {
    ...
    1 > t.length || $("#product-intro").hasClass("product-intro-nobook") ? $("#choose-result").hide() : (t.each(function() {
...
//    e.attr({href: t,"data-origin": encodeURIComponent(t)})
    ...
    window.jdSref = t(), window.jdSuri = new JDS.uri(window.jdSref), window.searchEngineSource = i(window.jdSuri)
        ...
        n.content = s, n.imgUrl = i, e.each(function() {
            var t = $(this).val();
            t && a.push(t)
        }), a.length && (n.type = a.join(","), $.ajax({url: "http://share.jd.com/share/shareBook.action",dataType: "jsonp",data: n,success: function(e) {
                var i = [], s = [];
...
//    G.isJd && "enabled" == pageConfig.btnBaiTiaoFq && t.after(e)
    ...
    if ($('#product-detail [data-widget="tab-book"]').find("a").addClass("toggle-link"), function() {
        function t(t) {
            var e = $(window).height(), i = $("body").scrollTop() || $("html").scrollTop(), s = t.offset().top;
            return e + i > s && s > i
        }
        var e, i, s = $(".detail-content"), a = s.find('[name^="detail-tag-id-"]'), d = [], p = $('#product-detail [data-widget="tab-book"]'), m = p.eq(0);
        return 1 > a.length ? !1 : (p.find("a").addClass("toggle-link"), o = function() {
            return 1 > a.length ? !1 : (m.addClass("p-tab"), 1 > m.find("a>s").length && m.find("a").append("<s></s>"), m.mouseover(function() {
                $(this).addClass("hover")
            }), 1 > m.find(".sub-book").length && (a.each(function() {
                var t = $(this).attr("id"), e = $(this).attr("text");
                d.push('<li data-id="' + t + '"><a data-id="#' + t + '" href="#' + t + '">' + e + "</a></li>")
            }), m.append('<ul class="hide sub-book">' + d.join("") + "</ul>"), e = m.children(), i = m.find("li"), m.find(".sub-book a").unbind("click").bind("click", function(t) {
                $(this).text();
        ...
        $(this).toggleClass("share-ft-open"), $(this).parents("#share-list").toggleClass("share-list-open"), $(".share-list-book").toggleClass("share-list-book-all")
...
//                }
        ...
        832 === G.cat[2] && (p = "737542"), d.addBook('<a class="research" target="_blank" href="http://surveys.jd.com/index.php?r=survey/index/sid/' + p + '/lang/zh-Hans"><b></b>\u8c03\u67e5\u95ee\u5377</a>'), d.setTop(), d.scroll()
    }
    if (setImButton(G.sku), 1319 === G.cat[0] && $.ajax({url: "http://misc.360buyimg.com/product/js/2012/book.baby.js?ver=20140123",cache: !0,dataType: "script",scriptCharset: "gb2312"}), jdSref && searchEngineSource) {
        var m = "&encode=utf-8";
    ...
    (function() {
       ...
       // pageConfig.disabledSeoBanner || (t.push("2_163_5395"), t.push("2_163_5394")), 1315 === G.cat[0] && $("#Ad2_100_2272").length > 0 && t.push("2_100_2272"), G.isPop && t.push("2_601_3951"), $.ajax({url: "http://nfa.jd.com/loadFa_toJson.js?aid=" + t.join("-") + "&ver=20131107",dataType: "script",cache: !0}), insertScript("http://static.360buyimg.com/gemini/gemini/gemini_v2.2.1.js", {id: "1399174259281",name: "gemini_divide_script",charset: "utf-8",divideType: "MODULE_INJECT",param: "[{t:'xiaoyumi'}]"})
        ...
        JA && JA.tracker.ngloader("book.010002", {sku: G.sku,jp: pageConfig.product.jp})
    }), $("#choose-btn-coll b").click(function() {
        JA && JA.tracker.ngloader("book.010003", {sku: G.sku})
    }), function() {
        ...
        var t = $("#bookover-related-list"), e = pageConfig.compatible && pageConfig.wideVersion ? 12 : 9;
        if ("undefined" != typeof warestatus && 0 === warestatus) {
            t.show(), t.find("p").html("\u7c7b\u4f3c\u5546\u54c1");
            var i = '<div class="w">    <div id="out-of-stock" class="m m2 hide">        <div class="mt">            <h2>\u642d\u914d\u63a8\u8350</h2>        </div>        <div class="mc">            <div id="nobook-related-list">                <div class="nobook-related-list">                    <a href="javascript:;" class="spec-control disabled" id="nobook-forward"></a>                    <a href="javascript:;" class="spec-control" id="nobook-backward"></a>                    <div id="nobook-list">                            <div class="iloading">\u6b63\u5728\u52a0\u8f7d\u4e2d\uff0c\u8bf7\u7a0d\u5019...</div>                    </div>                </div>            </div>        </div>    </div></div>';
            $("#product-intro").parent().after(i), new Grecommend(G.sku, 902011, readCookie("ipLoc-djd"), t, e), new Grecommend(G.sku, 902018, readCookie("ipLoc-djd"), $("#out-of-stock #nobook-list"), 20)
        }
    }(), function() {
        var t = $("#preview .spec-books li img"), e = [], i = $("#share-list li");
        t.each(function() {
            var t = $(this).attr("src");
            e.push(t)
        });
...
//            }})
    ...
    (t.bookShopJsona && t.bookShopJsona.searchLink || t.bookShopJsonb && t.bookShopJsonb.shopCategory) && ($("#sp-category").after('<div id="browse-browse-pop" class="m m2 hide related-buy"><div class="mt"><h2>\u770b\u4e86\u53c8\u770b</h2></div><div class="mc"></div></div>'), new Grecommend(G.sku, 902029, readCookie("ipLoc-djd"), $("#browse-browse-pop .mc")))
}(window);
