...
<li class="book-book" bookid="11078102">
	<div class="p-img">
		<a target="_blank" href="http://localhost:8082/book/${book.id }.html">
			<img width="160" height="160" data-img="1" data-lazyload="${book.image}" />
		</a>
	</div>
	<div class="p-name">
		<a target="_blank" href="http://localhost:8082/book/${book.id }.html">
	...
	<div class="p-price">
		<i>图书价：</i>
		<strong>￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${book.price / 100 }"/></strong>
	</div>
	<div class="service">由本店发货</div>
	<div class="extra">
