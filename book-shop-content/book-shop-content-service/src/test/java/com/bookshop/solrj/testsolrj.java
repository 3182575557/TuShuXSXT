...
public class testsolrj {
	...
	public void addDocument() throws Exception {
		...
		document.addField("book_title", "测试图书2");
		document.addField("book_price", "199");
		// 第五步：把文档添加到索引库中。
	...
	public void deleteDocumentByQuery() throws Exception {
		...
		solrServer.deleteByQuery("book_title:测试图书2");
		// 第三步：提交。
		solrServer.commit();
	}
	...
	public void searchDocumet() throws Exception {
		...
		for (SolrDocument solrDocument : solrDocumentList) {
			...
			if (list != null && list.size() >0) {
				bookTitle = list.get(0);
			} else {
				bookTitle = (String) solrDocument.get("book_title");
			}
			System.out.println(bookTitle);
			System.out.println(solrDocument.get("book_sell_point"));
			System.out.println(solrDocument.get("book_price"));
			System.out.println(solrDocument.get("book_image"));
			System.out.println(solrDocument.get("book_category_name"));
			System.out.println("=============================================");
		}
